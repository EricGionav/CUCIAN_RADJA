 ...
 * @author ACER
 */
public class Owner_User extends javax.swing.JFrame {

    /**
     * Creates new form Owner_User
     */
    public Owner_User() {
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        role.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kasir", "pelanggan", "cleaner" }));
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        try (Connection conn = Owner_User.DatabaseConnection.getConnection()) {
 ...
 int row = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Owner_User.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Owner_User().setVisible(true);
            }
        });
    }
